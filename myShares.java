public final class myShares extends Shares
{
    private String name;
    private double value;
    private int units;
    public myShares(String Name, double Value,int Units) //This creates shares
    {
        name = Name;
        value = Value;
        units = Units;
    ...
    public void SetValue(Shares s, double amount) //This changes the value
    {
